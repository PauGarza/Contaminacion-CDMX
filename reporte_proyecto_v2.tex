...
\subsection*{Limpieza y preparaci\'on de datos ---
             \texttt{limpieza\_valle\_mexico\_v2.R}}
%--------------------------------------------------------------
\lstinputlisting[language=R]{scripts/limpieza_valle_mexico_v2.R}

%--------------------------------------------------------------
\subsection*{An\'alisis exploratorio de datos ---
             \texttt{eda\_valle\_mexico\_v2.R}}
%--------------------------------------------------------------
\lstinputlisting[language=R]{scripts/eda_valle_mexico_v2.R}

%--------------------------------------------------------------
\subsection*{Modelos A, B, C1, C2 y D ---
             \texttt{modelos\_A\_B\_C1\_D\_v2.R}}
%--------------------------------------------------------------
\lstinputlisting[language=R]{scripts/modelos_A_B_C1_D_v2.R}

%--------------------------------------------------------------
\subsection*{Modelo E --- Proceso Gaussiano y Kriging ---
             \texttt{modelo\_E\_valle\_v2.R}}
%--------------------------------------------------------------
\lstinputlisting[language=R]{scripts/modelo_E_valle_v2.R}

%--------------------------------------------------------------
\subsection*{Mapa de predicci\'on espacial ---
             \texttt{mapa\_valle\_mexico\_v2.R}}
%--------------------------------------------------------------
\lstinputlisting[language=R]{scripts/mapa_valle_mexico_v2.R}
